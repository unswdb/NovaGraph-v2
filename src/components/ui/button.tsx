...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm transition-all disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-6 shrink-0 [&_svg]:shrink-0 focus-visible:border-border focus-visible:ring-outline outline-none focus-visible:ring-1 aria-invalid:ring-critical/20 aria-invalid:border-critical cursor-pointer",
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          "border border-border bg-page hover:bg-neutral-low hover:text-foreground disabled:bg-neutral-low disabled:text-neutral-fore-disabled",
        ghost:
