...
5. Wire into TS: add a typed wrapper and a method in `IgraphController` (see `../igraph/IgraphController.DOCS.md`).

### Pointers to more detail
- Data preparation: `../igraph/IgraphController.DOCS.md`
- Consumers and orchestration: `../MainController.DOCS.md`
